...
<div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <form id="reg" role="form" action="reg.php" method="GET">
          ...
          <div class="top-row">
            <div class="field-wrap">
              ...
              <input type="text" required autocomplete="on" name="fname"  />
            </div>
        ...
        <div id="login">   
          ...
          <form role="form" action="log.php" method="GET">
          
            <div class="field-wrap">
            <label>
              Email Address<span class="req">*</span>
            </label>
            <input type="email" id="txtEmail" name="email" required autocomplete="on"/>
          </div>
