<?php
	...
	$con->query("INSERT INTO bookevent (eventtype,eventplace,no_guests,date,equip,food,light,flowers,chair)
					VALUES ('$eventtype', '$eventplace', '$noguest', '$date', '$eq', '$foo', '$light', '$flowers', '$ch');");
