	...
	if(!$con)
	{
		die("Error : ".mysqli_connect_error());
	        ...
	        $bid=$_SESSION['BID'];
                ...
                if ($mail->send()){
                   echo "<script>alert('Successfully done!!');document.location='viewbooked.php'</script>";
                }
                else
  ...
  <div class="checkout-panel">
        <div class="panel-body">
                  ...
                  <div class="column-1">
                    ...
                    <div class="small-inputs">
                      ...
                      <div>
                        ...
                        <input type="password" maxlength="3" id="verification" name="cvv"/>
                      </div>
                    </div>
            ...
            <div class="panel-footer">
                    ...
                    <button class="btn next-btn" type="submit" name="sumit">Pay Now</button>
                  </div>
            </div>
    </form>
