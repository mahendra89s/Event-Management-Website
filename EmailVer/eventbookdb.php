<?php
	...
	$con->query("INSERT INTO bookevent (bid,eventtype,eventplace,no_guests,date,equip,food,light,flowers,chair)
					VALUES ('$bid','$eventtype', '$eventplace', '$noguest', '$date', '$eq', '$foo', '$light', '$flowers', '$ch');");
    
    header("location:eventbooking.html");
    }
